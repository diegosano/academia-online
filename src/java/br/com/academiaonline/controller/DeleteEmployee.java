...
public class DeleteEmployee extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            File curriculum = new File("C:\\Users\\Diego\\Documents\\NetBeansProjects\\ProjetoAcademiaOnline\\web\\employee\\" + request.getParameter("curriculum"));
            ...
            if (curriculum.delete()) {
                ...
                System.out.println("Error trying to delete curriculum!");
            }

        } catch (Exception ex) {
            System.out.println("Problemas ao excluir Employee(controller)! Erro: " + ex.getMessage());
        }
    }
