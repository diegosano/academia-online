...
public class ListVideoLesson extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("videolessons", dao.findAll());
            request.getRequestDispatcher("videolesson/list.jsp").forward(request, response);
            
        } catch (Exception ex) {
            System.out.println("Problemas ao listar Videoaulas(Controller)! Erro: " + ex.getMessage());
        }
    }
